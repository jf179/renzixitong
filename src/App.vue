<template>
  <div id="app">
    ...
    <!-- 只展示 了三个页面1:login  2:404  3:layout -->
    <router-view />
    <!-- 用法:svg-icon   iconClass="svg文件名"   -->
...
export default {
  ...
  async created () {
    ...
    //   .catch(() => {})
    // axios({
    //   // http://127.0.0.1/heimamm/ 设置基地址/heimamm
    //   // http://127.0.0.1/heimamm/public/captcha?type=sendsms
  ...
  watch: {
    $route (newVal) {
      window.console.log('路由变化了', newVal)
    }
  }
}
</script>
